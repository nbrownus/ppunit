...
/**
 * Any other non exclusive suite can run during a non exclusive suite
 * This is the default behavior of a suite
 *
 * @returns {Suite} This for chaining
 */
Suite.prototype.nonExclusive = function () {
    this.exclusivity = Suite.EXCLUSIVITY.NONE
    return this
}
...
Suite.prototype._prepareSuites = function (suites) {
    ...
    suites.forEach(function (suite) {
        ...
        if (suite.exclusivity === Suite.EXCLUSIVITY.NONE) {
            ...
            } else if (suite._nonExclusives.length) {
                self._nonExclusives = self._nonExclusives.concat(suite._nonExclusives.slice())
            } else {
