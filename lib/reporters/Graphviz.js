...
/**
 * Outputs graphviz dot notation of the test execution graph
 *
 ...
 * @constructor
 */
var GraphViz = function (ppunit, writer) {
    GraphViz.super_.call(this, ppunit, writer)
    var self = this
...
GraphViz.description = 'Outputs the test execution graph in graphviz dot notation'
 ...
 */
GraphViz.prototype.printDependencies = function () {
    var self = this
