...
BaseReporter.prototype.printError = function (error) {
    ...
    if (error.showDiff && typeof actual === typeof expected) {
        error.actual = actual = JSON.stringify(actual)
        error.expected = expected = JSON.stringify(expected)
    }
